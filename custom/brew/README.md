...
This directory contains Brewfile declarations that will be copied into your custom image at `/usr/share/ublue-os/homebrew/preinstall.d/`, where the base image's `brew-preinstall` user service installs them at first login.
...
1. **During Build**: Files in this directory are copied to `/usr/share/ublue-os/homebrew/preinstall.d/` in the image
